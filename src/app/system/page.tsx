  ...
  return (
    <>
      ...
      <section className="container-page py-10">
        <p className="badge-accent">— Trénink zdarma · 20 minut</p>
        ...
        <p className="mt-4 max-w-3xl font-display text-xl sm:text-2xl text-ink leading-snug">
          Jak podnikatelé získali +10 000 sledujících pomocí 5–8 sekundových videí — bez
          agentury, štěstí a jen pomocí telefonu.
        </p>

        <div className="mt-10 max-w-4xl">
          <VslPlayer youtubeId={ytId} src={!ytId ? videoSrc : undefined} title="Growmat Systém®" />
      ...
      <section className="border-t border-line bg-surface">
        <div className="container-page py-16 max-w-3xl">
          ...
          <div className="mt-6 space-y-4 text-lg text-ink leading-relaxed">
            <p>
      ...
      <section className="container-page py-20">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 max-w-md">
            <CheckoutButton prefill={prefill} />
      ...
      {/* SECTION 4: TIER 2 SOCIAL PROOF */}
      <section className="border-y border-line bg-surface">
        <div className="container-page py-20">
          <p className="eyebrow text-center">— Výsledky členů</p>
          ...
          <p className="mt-4 text-center text-muted max-w-2xl mx-auto">
            4 členové Projektu Organika. 4 různé příběhy. 1 systém. A společně přes{" "}
          ...
          <div className="mt-10 max-w-2xl mx-auto border border-line bg-white p-6">
            <p className="text-sm text-muted">
              🔒 <strong className="text-ink">Všechny screenshoty si můžeš ověřit přímo v Circle komunitě.</strong>{" "}
      ...
      <section className="container-page py-20">
        <div className="max-w-3xl">
          ...
          <ul className="mt-6 space-y-4 text-lg text-ink">
            ...
            <PainItem>
              <strong>Sleduješ ostatní podnikatele</strong>, jak rostou, a říkáš si: „Co dělají,
              co já ne?“
            </PainItem>
            <PainItem>
              <strong>Zkoušel jsi všechno</strong> — kurzy, návody, šablony. A pořád stagnuješ.
            </PainItem>
          </ul>
          <p className="mt-8 text-lg text-muted">
            ...
            <strong className="text-ink">systém</strong>, jak to dostat ven tak, aby to lidi
            sledovali, sdíleli a kupovali si to.
          </p>
        </div>
      </section>
      ...
      <section className="border-y border-line bg-surface">
        <div className="container-page py-20 max-w-3xl">
          ...
          <blockquote className="mt-10 border-l-4 border-accent pl-5 font-display text-xl text-ink">
            Problém nikdy nebyl v tom, co víš. Chyběl ti systém, JAK to dostat ven.
          </blockquote>
        </div>
      </section>
      ...
      <section className="container-page py-20">
        <p className="eyebrow">— Co konkrétně dostaneš</p>
      ...
      <section className="border-y border-line bg-surface">
        <div className="container-page py-20">
          <p className="eyebrow">— + Co dostaneš navíc</p>
          <h2 className="mt-3 font-display text-3xl sm:text-4xl font-bold tracking-tight">
            Bonusy v hodnotě <span className="text-accent">33 920 Kč</span>, které ti urychlí
            výsledky
          </h2>
      ...
      {/* SECTION 11: TIER 1 SOCIAL PROOF */}
      <section className="container-page py-20">
        <div className="max-w-3xl">
          ...
          <p className="mt-8 font-display text-xl text-ink">
            ...
            <span className="text-accent">systém, jak je dostat ven</span>.
          </p>
      ...
      <section className="border-y border-line bg-surface">
        <div className="container-page py-20 max-w-3xl">
          ...
          <p className="mt-3 text-muted">
            A přesto — pokud do konce 3. dne <strong>necítíš alespoň 3 konkrétní „aha
            momenty“</strong>, pošlu ti{" "}
          ...
          <div className="mt-8 max-w-md">
            <CheckoutButton prefill={prefill} label="Jdu do toho →" />
          </div>
        </div>
      </section>
      ...
      <section className="container-page py-20">
        <div className="max-w-3xl">
          <p className="eyebrow">— Pro koho to není</p>
          <h2 className="mt-3 font-display text-3xl font-bold tracking-tight">
      ...
      <section className="container-page py-20 max-w-3xl">
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-6">
          ...
          <div className="border border-accent bg-accent-50 p-6">
            <p className="eyebrow text-accent-700">— Možnost 2</p>
            <p className="mt-3 text-ink leading-relaxed">
              Vstoupíš teď. Za 3 dny máš profil. Máš první video. Máš systém na 14 dní obsahu.
              A přístup ke mně, na celý život.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 max-w-md">
          <CheckoutButton prefill={prefill} />
          <p className="mt-3 text-xs text-muted">🔒 Okamžitý přístup po platbě · Doživotně tvé</p>
        </div>
      </section>
      ...
      <section className="border-t border-line bg-surface">
        <div className="container-page py-20 max-w-3xl">
          <p className="eyebrow">— P.S.</p>
          <p className="mt-5 text-lg text-ink leading-relaxed">
            Většina lidí, co dosledovala video až sem, zavře stránku. Přečtou ještě pár
            recenzí. Možná otevřou konkurenční kurz. A za týden zapomenou, že tu kdy byli.
          </p>
...
function Member({
  ...
  return (
    <div className="border border-line bg-white p-6">
      ...
      <div className="mt-4 aspect-video bg-line flex items-center justify-center text-muted font-mono text-xs">
        [screenshot]
      </div>
    </div>
  );
...
function Day({
  ...
  return (
    <div className="grid md:grid-cols-[80px_1fr] gap-6 border-l-2 border-accent pl-6">
...
function Bonus({ title, value, body }: { title: string; value: string; body: string }) {
  return (
