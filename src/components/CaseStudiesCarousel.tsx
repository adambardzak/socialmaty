    ...
    <div>
      ...
      >
        {cases.map((c, i) => (
          ...
          >
            <div className="relative aspect-[9/12] bg-surface">
              <Image src={c.before} alt={`${c.handle} – před`} fill className="object-cover" sizes="300px" />
            ...
            <div className="relative aspect-[9/12] bg-surface">
              <Image src={c.after} alt={`${c.handle} – po`} fill className="object-cover" sizes="300px" />
